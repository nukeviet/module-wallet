...
$lang_module['chose_account_number'] = 'Chọn số tài khoản nhận';
$lang_module['copy'] = 'Sao chép';
$lang_module['status_waiting_pay'] = 'Đang chờ thanh toán...';
...
$lang_module['customer_tax_address'] = 'Địa chỉ nhận hóa đơn';
...
$lang_module['note_pay1'] = 'Nạp tiền vào tài khoản';
...
$lang_module['datetransaction1'] = 'Thời điểm khởi tạo';
...
$lang_module['infotransaction1'] = 'Dữ liệu chờ thanh toán';
...
$lang_module['atm_menthod1'] = 'Cách 1: Mở app ngân hàng và quét mã QR bên dưới';
$lang_module['atm_menthod2'] = 'Cách 2: Chuyển khoản thủ công theo thông tin bên dưới';
$lang_module['atm_isnoqr'] = 'Không có ảnh? Hãy thử tải lại trang';
$lang_module['atm_guide'] = 'Hướng dẫn thanh toán qua chuyển khoản ngân hàng';
$lang_module['atm_blockstatus'] = 'Trạng thái hiện tại là <strong>%s</strong>. Bạn không thể tiếp tục giao dịch, xin vui lòng thực hiện giao dịch mới hoặc liên hệ với nhân viên hỗ trợ nếu bạn thấy đây là lỗi';
$lang_module['atm_mess_note'] = '<strong>Lưu ý:</strong> Vui lòng giữ nguyên nội dung chuyển khoản <strong>%s</strong> để xác nhận thanh toán tự động';
...
$lang_module['atm_error_toacc1'] = 'Lỗi: Chưa chọn số tài khoản nhận';
...
$lang_module['atm_select_acq_id2'] = 'Thụ hưởng';
$lang_module['atm_banknum'] = 'Số tài khoản';
$lang_module['atm_sendmessage'] = 'Nội dung CK';
...
$lang_module['atm_waittimeout'] = 'Chúng tôi không tìm thấy thông tin đã thanh toán của bạn. Nếu bạn đã thanh toán xong, xin vui lòng liên hệ với nhân viên hỗ trợ';
$lang_module['atm_payok'] = 'Giao dịch thành công. Hệ thống sẽ tiếp tục xử lý trong giây lát, xin vui lòng không tắt trình duyệt';
