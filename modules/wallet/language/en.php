...
$lang_module['chose_account_number'] = 'Choose account number';
$lang_module['copy'] = 'Copy';
$lang_module['status_waiting_pay'] = 'Waiting for payment...';
...
$lang_module['customer_tax_address'] = 'Bill address';
...
$lang_module['note_pay1'] = 'Deposit funds';
...
$lang_module['datetransaction1'] = 'Initialization time';
...
$lang_module['infotransaction1'] = 'Data pending payment';
...
$lang_module['atm_blockstatus'] = 'Current status is <strong>%s</strong>. You cannot continue the transaction, please make a new transaction or contact support if you see this as an error';
...
$lang_module['atm_error_toacc1'] = 'Error: Receiving account is empty';
...
$lang_module['atm_select_acq_id2'] = 'Beneficiary';
...
$lang_module['atm_mess_note'] = '<strong>Note:</strong> Please keep the transfer content <strong>%s</strong> to confirm automatic payment';
$lang_module['atm_guide'] = 'Instructions for payment via bank transfer';
$lang_module['atm_menthod1'] = 'Method 1: Open the banking app and scan the QR code below';
$lang_module['atm_menthod2'] = 'Method 2: Manual transfer according to the information below';
$lang_module['atm_isnoqr'] = 'No QR image? Try reloading the page';
$lang_module['atm_banknum'] = 'Account number';
$lang_module['atm_sendmessage'] = 'Transfer Contents';
$lang_module['atm_waittimeout'] = 'We could not find your payment information. If you have already paid, please contact support.';
$lang_module['atm_payok'] = 'Successful transaction. The system will continue processing for a moment, please do not close the browser';
