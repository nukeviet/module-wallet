...
// Tiếng Việt
$nv_update_config['lang']['vi']['nv_up_f1'] = 'Cập nhật CSDL phiên bản 4.1.02';
$nv_update_config['lang']['vi']['nv_up_f2'] = 'Cập nhật CSDL phiên bản 4.3.00';
    ...
    try {
        ...
        if (!$num) {
            $db->query("INSERT INTO " . $db_config['prefix'] . "_setup_extensions (
                ...
                269, 'module', '" . $nv_update_config['formodule'] . "', 0, 1, '" . $nv_update_config['formodule'] . "', '" . $nv_update_config['formodule'] . "', '" . $nv_update_config['to_version'] . " " . $nv_update_config['release_date'] . "', " . NV_CURRENTTIME . ", 'VINADES.,JSC (contact@vinades.vn)',
                ''
            )");
        } else {
